...
public class AnotherExample {
 ...
 //Note: Disable Browser cache history, otherwise the messages sent to browser may be incorrect
    
 private final static Logger LOGGER = Logger.getLogger(Example.class.getName());
 
 @GET
 @Produces(MediaType.TEXT_PLAIN)
 public Response byebye() throws Exception  {
...
//50 is the maximum and the 1 is our minimum 
  ...
  if((x%2)==0)  {
   ...
   return Response.ok("See you later.").build();     //200 code
  }
  else  {
   // odd
